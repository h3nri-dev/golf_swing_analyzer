...
- `deploy/moments.js`: moment menus immediately after each Play button; frame editing and jumps must remain local when Sync is off. Display clocks, markers and ranges in real seconds and label zero-based frame numbers.
