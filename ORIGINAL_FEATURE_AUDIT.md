...
- **Trim timeline magnification:** restored as automatic expansion of the playback timeline to the completed analysis window, with Analyzed range / Full video controls immediately beside it. Numbered phase labels stay selectable with connectors to their precise timestamps. The broad sliding selector remains a full-clip overview for choosing the next window; spatial video zoom is separate. Looping remains explicit.
