...
- **Loop window**, beside the analysis range, repeats the pinned interval during playback. Independently loop either video, or use Sync on to loop their overlapping calibrated intervals. Follow ±5s turns looping off.
